...
#mESC
component_lis[1,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#mMacro_p20_ips
component_lis[2,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#Macro_p3_ips
component_lis[3,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_p20_ips
component_lis[4,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_p3_ips
component_lis[5,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#mNSC_p20
component_lis[6,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#mNSC_p3
component_lis[7,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#mPreb_p20
component_lis[8,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#mPreb_p3
component_lis[9,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_scNoHS
component_lis[10,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_scHS3hr
component_lis[11,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_shNoHS
component_lis[12,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
#MEF_shHS3h
component_lis[13,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
component_lis[14,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
...
colnames(component_lis)=chr_lis
component_lis[1,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
component_lis[2,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
component_lis[3,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
component_lis[4,]=c(2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2)
...
outputfile=paste(pwd,paste(file_name,"PC2_A.B.label",sep='.'),sep='/')
...
#####################DRAW the one component heatmap######################################################
		png(paste(pwd,figfolder,paste(input_heatmap[i],"select_second_compo","png",sep='.'),sep='/'))
...
#			par(mar=c(0,0,0,0))
# 			image(matrix(as.numeric(compart_list),length(compart_list),1),xaxt="n",yaxt="n",col=c("seagreen","lightgrey","red"),breaks=c(-2,-0.9,0.9,2)) #remove this line if we do not wanna plot the second track!!!
#			dev.off()
