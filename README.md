...
|`uniq`|Filter out adjacent duplicate lines in a file|  |`uniq filename` removes adjacent duplicate lines and shows only one of each  <br> `sort filename` Sorts the lines in a file and removes duplicate lines | 
